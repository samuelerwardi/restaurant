...
@section('content')
    <section class="content">
        <div class="box box-info">
            ...
            <!-- form start -->
            <form class="form-horizontal" action="{{ action("MasterBahanController@store") }}" id="form"
                  method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="kode_bahan" type="text" class="form-control" id="kode_bahan"
                                   placeholder="Kode Bahan" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="nama_bahan" type="text" class="form-control" id="nama_bahan"
                                   placeholder="Nama Bahan" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
