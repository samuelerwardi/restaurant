                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped datatable datatable-client">
                        ...
                        <tr>
                            ...
                            <td width="16%">
                                <a href="{{action('SupplierController@edit',$value['id'])}}" class="btn btn-default fa fa-edit btn-default btn_edit">
                                    <i class="icon-pencil icon-white"></i> Edit
                                </a>


                                <form action="{{action('SupplierController@destroy',$value['id'])}}" method="POST" style="display : inline-table">
                                    @method('DELETE')
