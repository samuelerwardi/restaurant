...
@section('content')
    <section class="content">
        <div class="box box-info">
            ...
            <!-- form start -->
            <form class="form-horizontal" action="{{ action("SupplierController@store") }}" id="form"
                  method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="contact_person" type="text" class="form-control" id="contact_person"
                                   placeholder="Nama Kontak" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="kode" type="text" class="form-control" id="kode"
                                   placeholder="Kode" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="nama" type="text" class="form-control" id="nama"
                                   placeholder="Nama" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="email" type="email" class="form-control" id="email"
                                   placeholder="Email" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="telepon" type="text" class="form-control" id="telepon"
                                   placeholder="Telepon" required autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group">
