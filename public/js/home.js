$(document).ready(function(){
	...
	var stock_alert_table = $('#stock_alert_table').DataTable({
					...
					dom: 'tirp',
					buttons:[],
					ajax: 'http://dev.ultimate-pos.localhost/home/product-stock-alert'
			    });
	...
	var payment_dues_table = $('#payment_dues_table').DataTable({
					...
					dom: 'tirp',
					buttons:[],
					ajax: 'http://dev.ultimate-pos.localhost/home/payment-dues',
...
function update_statistics( start, end ){
	...
	$.ajax({
		method: "POST",
		url: 'http://dev.ultimate-pos.localhost/home/get-purchase-details',
		dataType: "json",
		data: data,
	...
	$.ajax({
		method: "POST",
		url: 'http://dev.ultimate-pos.localhost/home/get-sell-details',
		dataType: "json",
		data: data,
		success: function(data){
